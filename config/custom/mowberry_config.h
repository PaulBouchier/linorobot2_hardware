...
#define COUNTS_PER_REV1 70                  // wheel1 encoder's no of ticks per rev
#define COUNTS_PER_REV2 70                  // wheel2 encoder's no of ticks per rev
...
#define LR_WHEELS_DISTANCE 0.212            // distance between left and right wheels
