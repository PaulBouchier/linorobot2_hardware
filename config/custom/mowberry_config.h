...
#ifndef MOWBERRY_CONFIG_H
#define MOWBERRY_CONFIG_H
...
#define MOTOR_MAX_RPM 65                    // motor's max RPM
#define MAX_RPM_RATIO 0.85                  // max RPM allowed for each MAX_RPM_ALLOWED = MOTOR_MAX_RPM * MAX_RPM_RATIO
#define MOTOR_OPERATING_VOLTAGE 26          // motor's operating voltage (used to calculate max RPM)
#define MOTOR_POWER_MAX_VOLTAGE 26          // max voltage of the motor's power source (used to calculate max RPM)
#define MOTOR_POWER_MEASURED_VOLTAGE 26     // current voltage reading of the power connected to the motor (used for calibration)
#define COUNTS_PER_REV1 2800                // wheel1 encoder's no of ticks per rev
#define COUNTS_PER_REV2 2800                // wheel2 encoder's no of ticks per rev
...
#define LR_WHEELS_DISTANCE 0.52             // distance between left and right wheels
...
// MOTOR PINS
  ...
  #define PWM_MAX pow(2, PWM_BITS) - Right M-1
  #define PWM_MIN -PWM_MAX
#endif
...
// Enable WiFi by copying wifi_config.h.template to wifi_config.h and filling
// in your wifi credentials, and IP addresses. This wifi_config.h will be ignored by git,
// so your credentials will not be shared.
...
// Ultrasonic range sensor HC-SR04 pin settings
// #define TRIG_PIN 13
// #define ECHO_PIN 12
...
#define DEVICE_HOSTNAME "mowberry"
