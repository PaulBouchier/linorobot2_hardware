...
#ifndef MINIPET_WIFI_CONFIG_H
#define MINIPET_WIFI_CONFIG_H
...
#define MOTOR_POWER_MEASURED_VOLTAGE 8.4    // current voltage reading of the power connected to the motor (used for calibration)
#define COUNTS_PER_REV1 1035                // wheel1 encoder's no of ticks per rev
#define COUNTS_PER_REV2 1035                // wheel2 encoder's no of ticks per rev
...
#define AGENT_IP { 192, 168, 4, 233 }  // home wifi
#define SYSLOG_SERVER { 192, 168, 4, 252 }
#define LIDAR_SERVER { 192, 168, 4, 233 }  // eg IP of the desktop computer
...
// #define AGENT_IP { 192, 168, 8, 106 }
// #define SYSLOG_SERVER { 192, 168, 8, 106 }
// #define LIDAR_SERVER { 192, 168, 8, 106 }

// 129Spare
// #define WIFI_AP_LIST {{"129Spare", "129Robots"}, {NULL}}
// #define AGENT_IP { 192, 168, 2, 197 }
// #define SYSLOG_SERVER { 192, 168, 2, 197 }
// #define LIDAR_SERVER { 192, 168, 2, 197 }
...
#define DEVICE_HOSTNAME "minipet_wifi"
